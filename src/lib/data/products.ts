...
export const products: Product[] = [
  {
    ...
    images: [
      {
        src: null,
        alt: "A set of custom photo magnets showing family, wedding, baby and pet photographs arranged on a refrigerator door.",
        width: 1200,
        height: 1500,
      },
      {
        src: null,
        alt: "Close-up of a single custom photo magnet held between two fingers.",
        width: 1200,
        height: 1500,
      },
    ],
...

  {
    ...
    images: [
      {
        src: null,
        alt: "Two personalized photo keychains, one showing a couple and one showing a golden retriever.",
        width: 1200,
        height: 1500,
      },
    ],
...

  {
    ...
    images: [
      {
        src: null,
        alt: "An event keepsake card with a thank you message and three photographs of a couple, styled with eucalyptus leaves.",
        width: 1200,
        height: 1500,
      },
    ],
...

  {
    ...
    images: [
      {
        src: null,
        alt: "A personalized photo keepsake gift presented on a warm neutral surface.",
        width: 1200,
        height: 1500,
      },
    ],
